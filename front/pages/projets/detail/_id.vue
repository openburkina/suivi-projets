        ...
        <v-tab-item value="tab-1" class="mb-9">
          ...
          <v-card class="mx-auto" max-width="900">
            ...
            <v-list-item>
              ...
              <v-list-item-subtitle>{{ getProjet().project_id}}</v-list-item-subtitle>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item>
            ...
            <v-list-item>
              <v-list-item-title
                >Decription</v-list-item-title
              >
              <v-list-item-subtitle>{{
                getProjet().description
              }}</v-list-item-subtitle>
            </v-list-item>
