<template>
 ...
 <v-navigation-drawer
    ...
    >
      ...
      <div v-else>
        <v-btn to="/" text>
          <span class="mr-2 black--text">Accueil</span>
        </v-btn>

         <Menu-projects-page/>

        <v-btn text to="/backers">
          <span class="mr-2  black--text">Bailleurs</span>
        </v-btn>
        <v-btn text to="/sustainable">
          <span class="mr-2  black--text">ODD</span>
        </v-btn>
        <v-btn text to="/approche">
          <span class="mr-2  black--text">NOS APPROCHES</span>
        </v-btn>
        <!-- More menu -->
          <Menu-page />
      </div>
