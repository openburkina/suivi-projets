...
class Output(models.Model):
    ...
    organisation = models.ForeignKey(Organisation, related_name='reporting_org', blank=True, null=True, on_delete=models.DO_NOTHING)
    ...
    signature_solution = models.ForeignKey(SignatureSolution, blank=True, null=True, default=0, on_delete=models.DO_NOTHING)
...
class ActivityDate(models.Model):
    output = models.ForeignKey(Output, db_index=True, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, on_delete=models.DO_NOTHING)
...
class OutputSector(models.Model):
    output = models.ForeignKey(Output, db_index=True, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, on_delete=models.DO_NOTHING)
    sector = models.ForeignKey(Sector, db_index=True, on_delete=models.DO_NOTHING)
...
class CountryBudgetItem(models.Model):
    country_budget = models.ForeignKey(CountryBudget, on_delete=models.DO_NOTHING)
...
class Budget(models.Model):
    output = models.ForeignKey(Output, db_index=True, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, db_index=True, on_delete=models.DO_NOTHING)
...
class OutputTransaction(models.Model):
    output = models.ForeignKey(Output, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, on_delete=models.DO_NOTHING)
    provider = models.ForeignKey(Organisation, related_name='provider_org', blank=True, null=True, on_delete=models.DO_NOTHING)
    receiver = models.ForeignKey(Organisation, related_name='receiver_org', blank=True, null=True, on_delete=models.DO_NOTHING)
...
class Expense(models.Model):
    output = models.ForeignKey(Output, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, on_delete=models.DO_NOTHING)
    provider = models.ForeignKey(Organisation, related_name='expense_provider_org', blank=True, null=True, on_delete=models.DO_NOTHING)
    transaction_type = models.CharField(max_length=10)
    transaction_date = models.DateField()
    amount = models.FloatField(blank=True, null=True, db_index=True)
    amount_date = models.DateField(blank=True, null=True)
...
class OutputLocation(models.Model):
    output = models.ForeignKey(Output, db_index=True, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, db_index=True, on_delete=models.DO_NOTHING)
    operating_unit = models.ForeignKey(OperatingUnit, null=True, blank=True, on_delete=models.DO_NOTHING)
...
class OutputResultPeriod(models.Model):
    result = models.ForeignKey(OutputResult, db_index=True, on_delete=models.DO_NOTHING)
...
class OutputActiveYear(models.Model):
    output = models.ForeignKey(Output, related_name='output_active', on_delete=models.DO_NOTHING)
...
class OutputTarget(models.Model):
    output = models.ForeignKey(Output, db_index=True, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project, on_delete=models.DO_NOTHING)
    target_id = models.ForeignKey(SdgTargets, db_index=True, on_delete=models.DO_NOTHING)
...
class ProjectMarker(models.Model):
    output = models.ForeignKey(Output, related_name='marker_output', null=False, on_delete=models.DO_NOTHING)
