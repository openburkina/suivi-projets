...
class OperatingUnit(models.Model):
    ...
    bureau = models.ForeignKey(Bureau, blank=True, null=True, on_delete=models.DO_NOTHING)
...
class SdgTargets(models.Model):
    ...
    sdg = models.ForeignKey(Sdg, null=False, on_delete=models.DO_NOTHING)
...
class SignatureSolution(models.Model):
    ...
    sp_id = models.ForeignKey(Sector, null=True, blank=True, on_delete=models.DO_NOTHING)
    name = models.CharField(max_length=255, db_index=True)
